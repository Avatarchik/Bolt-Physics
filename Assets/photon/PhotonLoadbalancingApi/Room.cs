    ...
    public class Room : RoomInfo
    {
        ...
        public new bool IsOpen
        {
            ...
            set
            {
                ...
                {
                    LoadBalancingClient.OpSetPropertiesOfRoom(new Photon.Hashtable() { { GamePropertyKey.IsOpen, value } });
                }
        ...
        public new bool IsVisible
        {
            ...
            set
            {
                ...
                {
                    LoadBalancingClient.OpSetPropertiesOfRoom(new Photon.Hashtable() { { GamePropertyKey.IsVisible, value } });
                }
        ...
        public new byte MaxPlayers
        {
            ...
            set
            {
                ...
                {
                    LoadBalancingClient.OpSetPropertiesOfRoom(new Photon.Hashtable() { { GamePropertyKey.MaxPlayers, value } });
                }
        ...
        public virtual void SetCustomProperties(Photon.Hashtable propertiesToSet, Photon.Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
        ...
        {
            Photon.Hashtable customProps = new Photon.Hashtable();
        ...
        public bool SetMasterClient(Player masterClientPlayer)
        {
            ...
            Photon.Hashtable newProps = new Photon.Hashtable() { { GamePropertyKey.MasterClientId, masterClientPlayer.ID } };
            Photon.Hashtable prevProps = new Photon.Hashtable() { { GamePropertyKey.MasterClientId, this.MasterClientId} };
        ...
        {
            Photon.Hashtable props = new Photon.Hashtable();
            props[GamePropertyKey.ExpectedUsers] = new string[0];
            Photon.Hashtable expected = new Photon.Hashtable();
