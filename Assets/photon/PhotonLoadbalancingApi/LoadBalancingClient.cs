...
namespace ExitGames.Client.Photon.LoadBalancing
{
    ...
    #if UNITY || NETFX_CORE
    using Photon.Hashtable = ExitGames.Client.Photon.Photon.Hashtable;
    ...
    public class LoadBalancingClient : IPhotonPeerListener
    {
        ...
        public bool OpJoinRandomRoom(Photon.Hashtable expectedCustomRoomProperties, byte expectedMaxPlayers, string[] expectedUsers = null)
        {
        ...
        /// <returns>If the operation could be sent currently (requires connection to Master Server).</returns>
        public bool OpJoinRandomRoom(Photon.Hashtable expectedCustomRoomProperties, byte expectedMaxPlayers, MatchmakingMode matchmakingMode)
        {
        ...
        /// <param name="expectedUsers">Optional list of users (by UserId) who are expected to join this game and who you want to block a slot for.</param>
        /// <returns>If the operation could be sent currently (requires connection to Master Server).</returns>
        public bool OpJoinRandomRoom(Photon.Hashtable expectedCustomRoomProperties, byte expectedMaxPlayers, MatchmakingMode matchmakingMode, TypedLobby lobby, string sqlLobbyFilter, string[] expectedUsers = null)
        {
            if (lobby == null)
            {
                lobby = TypedLobby.Default;
        ...
        /// <param name="propertiesToSet">Photon.Hashtable of Custom Properties that changes.</param>
        ...
        public bool OpSetCustomPropertiesOfActor(int actorNr, Photon.Hashtable propertiesToSet, Photon.Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
            ...
            Photon.Hashtable customActorProperties = new Photon.Hashtable();
        ...
        public bool OpSetCustomPropertiesOfActor(int actorNr, Photon.Hashtable propertiesToSet, Photon.Hashtable expectedProperties, bool webForward)
        {
        ...
        protected internal bool OpSetPropertiesOfActor(int actorNr, Photon.Hashtable actorProperties, Photon.Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
            if (this.CurrentRoom == null)
            {
                if (this.loadBalancingPeer.DebugOut >= DebugLevel.ERROR)
        ...
        public bool OpSetCustomPropertiesOfRoom(Photon.Hashtable propertiesToSet, Photon.Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
            Photon.Hashtable customGameProps = new Photon.Hashtable();
        ...
        /// <summary>Replaced by a newer version with WebFlags.</summary>
        [Obsolete("Use the overload with WebFlags.")]
        public bool OpSetCustomPropertiesOfRoom(Photon.Hashtable propertiesToSet, Photon.Hashtable expectedProperties, bool webForward)
        {
        ...
        /// <summary>Internally used to cache and set properties (including well known properties).</summary>
        /// <remarks>Requires being in a room (because this attempts to send an operation which will fail otherwise).</remarks>
        protected internal bool OpSetPropertiesOfRoom(Photon.Hashtable gameProperties, Photon.Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
            if (this.CurrentRoom == null)
            {
                if (this.loadBalancingPeer.DebugOut >= DebugLevel.ERROR)
        ...
        /// </summary>
        /// <remarks>This override explicitly uses another parameter order to not mix it up with the implementation for Photon.Hashtable only.</remarks>
        /// <param name="eventCode">Identifies this type of event (and the content). Your game's event codes can start with 0.</param>
        /// <param name="customEventContent">Any serializable datatype (including Photon.Hashtable like the other OpRaiseEvent overloads).</param>
        ...
        /// </summary>
        private void ReadoutProperties(Photon.Hashtable gameProperties, Photon.Hashtable actorProperties, int targetActorNr)
        {
            ...
            if (actorProperties != null && actorProperties.Count > 0)
            {
                ...
                else
                {
                    ...
                    // value is a Photon.Hashtable with the actor's properties then)
                    int actorNr;
                    Photon.Hashtable props;
                    string newName;
                    Player target;
                    ...
                    {
                        actorNr = (int)key;
                        props = (Photon.Hashtable)actorProperties[key];
        ...
        /// <summary>
        /// Privately used only to read properties for a distinct actor (which might be the Photon.Hashtable OR a key-pair value IN the actorProperties).
        /// </summary>
        private Photon.Hashtable ReadoutPropertiesForActorNr(Photon.Hashtable actorProperties, int actorNr)
        {
            if (actorProperties.ContainsKey(actorNr))
            {
                return (Photon.Hashtable)actorProperties[actorNr];
            }
        ...
        private void GameEnteredOnGameServer(OperationResponse operationResponse)
        {
            ...
            Photon.Hashtable actorProperties = (Photon.Hashtable)operationResponse[ParameterCode.PlayerProperties];
            Photon.Hashtable gameProperties = (Photon.Hashtable)operationResponse[ParameterCode.GameProperties];
        ...
        protected internal virtual Player CreatePlayer(string actorName, int actorNumber, bool isLocal, Photon.Hashtable actorProperties)
        {
        ...
        public virtual void OnEvent(EventData photonEvent)
        {
            switch (photonEvent.Code)
            {
                ...
                case EventCode.GameListUpdate:
                    ...
                    Photon.Hashtable games = (Photon.Hashtable)photonEvent[ParameterCode.GameList];
                    foreach (string gameName in games.Keys)
                    {
                        RoomInfo game = new RoomInfo(gameName, (Photon.Hashtable)games[gameName]);
                ...
                case EventCode.Join:
                    ...
                    Photon.Hashtable actorProperties = (Photon.Hashtable)photonEvent[ParameterCode.PlayerProperties];
                ...
                case EventCode.PropertiesChanged:
                    ...
                    Photon.Hashtable props = (Photon.Hashtable)photonEvent[ParameterCode.Properties];
