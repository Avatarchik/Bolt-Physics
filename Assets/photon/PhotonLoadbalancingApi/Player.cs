...
namespace ExitGames.Client.Photon.LoadBalancing
{
    ...
    public class Player
    {
        ...
        /// <remarks>
        /// Don't modify the content of this Photon.Hashtable. Use SetCustomProperties and the
        ...
        /// <summary>Creates a Photon.Hashtable with all properties (custom and "well known" ones).</summary>
        /// <remarks>Creates new Photon.Hashtables each time used, so if used more often, cache this.</remarks>
        public Photon.Hashtable AllProperties
        {
            get
            {
                Photon.Hashtable allProps = new Photon.Hashtable();
        ...
        /// <param name="actorID">ID or ActorNumber of this player in the current room (a shortcut to identify each player in room)</param>
        /// <param name="isLocal">If this is the local peer's player (or a remote one).</param>
        /// <param name="playerProperties">A Photon.Hashtable of custom properties to be synced. Must use String-typed keys and serializable datatypes as values.</param>
        protected internal Player(string nickName, int actorID, bool isLocal, Photon.Hashtable playerProperties)
        {
            this.IsLocal = isLocal;
            this.actorID = actorID;
            this.NickName = nickName;

            this.CustomProperties = new Photon.Hashtable();
        ...
        /// </remarks>
        public virtual void CacheProperties(Photon.Hashtable properties)
        {
        ...
        public void SetCustomProperties(Photon.Hashtable propertiesToSet, Photon.Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
            Photon.Hashtable customProps = propertiesToSet.StripToStringKeys() as Photon.Hashtable;
        ...
        private void SetPlayerNameProperty()
        {
            if (this.RoomReference != null && this.RoomReference.IsLocalClientInside)
            {
                Photon.Hashtable properties = new Photon.Hashtable();
