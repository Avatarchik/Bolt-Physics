...
namespace ExitGames.Client.Photon.LoadBalancing
{
    ...
    public class LoadBalancingPeer : PhotonPeer
    {
        ...
        private void RoomOptionsToOpParameters(Dictionary<byte, object> op, RoomOptions roomOptions)
        {
            ...
            Photon.Hashtable gameProperties = new Photon.Hashtable();
        ...
        public virtual bool OpJoinRandomRoom(OpJoinRandomRoomParams opJoinRandomRoomParams)
        {
            ...
            Photon.Hashtable expectedRoomProperties = new Photon.Hashtable();
    ...
    public class ParameterCode
    {
        ...
        /// <summary>(249) Code for property set (Photon.Hashtable).</summary>
        ...
        /// <summary>(248) Code for property set (Photon.Hashtable).</summary>
        public const byte GameProperties = (byte)248;

        /// <summary>
        /// (251) Code for property-set (Photon.Hashtable). This key is used when sending only one set of properties.
    ...
    public class RoomOptions
    {
        ...
        /// </remarks>
        public Photon.Hashtable CustomRoomProperties;
