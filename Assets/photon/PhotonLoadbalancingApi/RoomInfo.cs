...
namespace ExitGames.Client.Photon.LoadBalancing
{
    ...
    public class RoomInfo
    {
        ...
        private Photon.Hashtable customProperties = new Photon.Hashtable();
        ...
        public Photon.Hashtable CustomProperties
        {
            get
            {
        ...
        protected internal RoomInfo(string roomName, Photon.Hashtable roomProperties)
        {
        ...
        /// <summary>Copies "well known" properties to fields (isVisible, etc) and caches the custom properties (string-keys only) in a local Photon.Hashtable.</summary>
        /// <param name="propertiesToCache">New or updated properties to store in this RoomInfo.</param>
        protected internal virtual void CacheProperties(Photon.Hashtable propertiesToCache)
        {
